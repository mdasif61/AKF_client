...
const SideNav = ({ children }) => {
  ...
  return (
    <div className="sideNav relative">
      <div className={`manu md:rounded-2xl rounded-r-2xl md:absolute fixed md:h-screen bg-white backdrop-blur-xl bg-opacity-60 z-50 ${showSideBar?' left-0 duration-500':'-left-96 duration-500'} min-h-screen md:sticky md:block md:w-[25%]`}>
        <p>
          <NavLink
